 ...
 *
 */
public class AnsjSegmentFactory extends NlpSegmentFactory<KeyValue<Analysis, List<Recognition>>> {
    ...
    @Override
    public KeyValue<Analysis, List<Recognition>> build(Map<String, String> configurations) {
        ...
        return new KeyValue<>(analysis, recognitions);
    }
