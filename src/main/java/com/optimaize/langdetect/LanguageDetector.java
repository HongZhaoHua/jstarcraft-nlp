...
public interface LanguageDetector {
     ...
     *
     * <p>
     * Note: you may want to use getProbabilities() instead. This here is very
     * strict, and sometimes returns absent even though the first choice in
     * getProbabilities() is correct.
     * </p>
     *
     * @param text You probably want a
     ...
     *
     * <p>
     * There is a configurable cutoff applied for languages with very low
     * probability.
     * </p>
     *
     * <p>
     * The way the algorithm currently works, it can be that, for example, this
     * method returns a 0.99 for Danish and less than 0.01 for Norwegian, and still
     * they have almost the same chance. It would be nice if this could be improved
     * in future versions.
     * </p>
     *
     * @param text You probably want a
     *             {@link com.optimaize.langdetect.text.TextObject}.
     * @return Sorted from better to worse. May be empty. It's empty if the program
     *         failed to detect any language, or if the input text did not contain
     *         any usable text (just noise).
     */
