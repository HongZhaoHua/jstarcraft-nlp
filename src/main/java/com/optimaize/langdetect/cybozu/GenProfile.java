...
public class GenProfile {
    ...
    public static LangProfile load(String lang, File file) {
        ...
        try (InputStream is = file.getName().endsWith(".gz") ? new GZIPInputStream(new BufferedInputStream(new FileInputStream(file))) : new BufferedInputStream(new FileInputStream(file))) {
