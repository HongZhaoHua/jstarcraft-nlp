...
import com.jstarcraft.nlp.tokenization.jcseg.JcsegIterator;

public class JcsegIteratorTestCase extends NlpIteratorTestCase {
    ...
    protected NlpIterator<? extends NlpToken> getTokenizer() {
        try {
            ...
            return new JcsegIterator(segment);
