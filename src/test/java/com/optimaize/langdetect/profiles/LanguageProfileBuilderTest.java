...
public class LanguageProfileBuilderTest {
    ...
    public void german() throws Exception {
        ...
        LanguageProfile languageProfile = new LanguageProfileBuilder("de").ngramExtractor(NgramExtractors.standard()).addText(inputText).build();
    ...
    public void profile_equals() throws Exception {
        LanguageProfile languageProfile1 = new LanguageProfileBuilder("de").addGram("foo", 1).build();

        LanguageProfile languageProfile2 = new LanguageProfileBuilder("de").addGram("foo", 1).build();

        LanguageProfile languageProfile3 = new LanguageProfileBuilder("de").addGram("bar", 1).build();
    ...
    public void profile_toString() throws Exception {
        LanguageProfile languageProfile = new LanguageProfileBuilder("de").addGram("foo", 1).build();
